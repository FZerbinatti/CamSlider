...
public class CounterHandler {
    ...
    private CounterHandler(Builder builder) {
        ...
        if (listener != null) {
            listener.onIncrement(incrementalView, startNumber, code);
            listener.onDecrement(decrementalView, startNumber, code);
        }
    }
    ...
    public interface CounterListener {
        void onIncrement(View view, long number, int code);

        void onDecrement(View view, long number, int code);
